...
public class RepaymentService {
    ...
    public void generateRepaymentSchedule(String applicationReferenceCode) {
        ...
        Map<LocalDate, RepaymentScheduleEntry> repaymentScheduleEntries = Stream.iterate(startDate, date->date.plusDays(30))
